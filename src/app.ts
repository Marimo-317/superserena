...
import { developmentRequestLogger, productionRequestLogger } from './middleware/requestLogger';
...
class App {
  ...
  private initializeMiddleware(): void {
    ...
    this.app.use(isDevelopment ? developmentRequestLogger : productionRequestLogger);
  }
